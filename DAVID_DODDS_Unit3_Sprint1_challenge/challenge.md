...
## An important part of code feedbacks is to actually give and listen for actionable items... ways that I could actually reform my code in the future to improve its intuitability. Compliments help too!

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

## Containers allow us to copy environments and packages exactly as they are compiled, and run them on an open source, virtual OS that lives beyond the Windows / Mac divide. Docker for the win!
